...
|---|---|---|---|---|---|
| A-V0 | 無相關情報 | 初入局，純粹的恐懼與茫然。女僕眼眶泛紅但公主不以為意；接受宰相送的項鍊，任由女僕打扮。三個選項（問賽拉斯、問父王、找宰相）在公主心中均指向同一個答案——賽拉斯是執行密令的人讓她害怕，父王下了殺令更不敢親近，只有宰相是「常送她東西、懂很多事」的可信任大人 | 宰相以帳本與貧民窟人證操弄公主對父王的疑慮，引導公主偷取密令；臨別以「身不由己」作別，並說出「不要怪我」——公主在意識消散前來不及理解發生了什麼，只帶著茫然與兩個無法解釋的記憶死去 | Bad End A：毒茶，意識消散 | `intel_chancellor_betrayal`（公主記住了兩件事：① 宰相那句不合理的「不要怪我」② 那杯茶獨特的氣味） |
...
| A-V2 | 持有 `intel_chancellor_betrayal` ＋ `intel_fake_ledgers`，未持有 `intel_chancellor_poison` | 確認宰相有問題且偽造了帳本，賽拉斯在父王身旁無法單獨接觸，只能正面求見父王——這是孤注一擲 | 公主盛裝求見，在賽拉斯面前當著大臣點破密令、邊境敵情與重稅；父王震驚後矢口否認，令士兵架走公主，召見宰相問責。公主被關入小房間，氣憤下喝了桌上的茶——瞬間認出那個氣味：蜂蜜、玫瑰、那一點點苦，**正是 A-V0 臨死時的那杯茶**。公主在意識消散前完成連結 | Bad End A''：公主連結到 A-V0 的死亡記憶，確認毒茶來源是宰相 | `intel_chancellor_poison`（確認：那杯茶與 A-V0 最後死亡時是同一種東西，連結到宰相）→ 觸發情境 A 主動鎖定 |

> **變體遞進邏輯：** A-V0 → A-V1 → A-V2 → LOCK。A-V0 公主死於茫然，帶著兩個微小的線索（「不要怪我」與茶的氣味）進入下一輪；A-V1 公主從賽拉斯臨終告白得知「是宰相，帳本是假的」；A-V2 公主在小房間認出茶的氣味，**連結到 A-V0 的死亡記憶**，確認毒茶來源是宰相。持有 `intel_chancellor_poison` 後此情境主動鎖定。
