...
| `b0_03_bad_end.dtl` | `03_loop2_anger_badend.dtl` | anger |
| `b0_04_forward_bad_end.dtl` | `04_loop2_anger_forward_badend.dtl` | anger |
| `b1_01_awakening.dtl` | `05_loop2_surveillance_awakening.dtl` | surveillance |
| `b1_02_guided_tour.dtl` | `06_loop2_surveillance_guided_tour.dtl` | surveillance |
| `b1_03_return_anomaly.dtl` | `07_loop2_surveillance_return_anomaly.dtl` | surveillance |
| `b1_04_bad_end.dtl` | `08_loop2_surveillance_badend.dtl` | surveillance |
| `b2_01_awakening.dtl` | `09_loop2_passage_awakening.dtl` | passage |
| `b2_02_follow_route.dtl` | `10_loop2_passage_follow_route.dtl` | passage |
| `b2_03_bad_end.dtl` | `11_loop2_passage_badend.dtl` | passage |

## Loop 3

| Old | New | Route |
| --- | --- | --- |
| `01_awakening_cold.dtl` | `01_loop3_entry_awakening.dtl` | entry |
...
| `03b_rush_arrest.dtl` | `04_final_badend_rush_arrest.dtl` | BADEND |
| `03c_dal_briefing.dtl` | `05_final_main_dal_briefing.dtl` | MAIN |
| `04_expose_chancellor.dtl` | `06_final_main_expose_chancellor.dtl` | MAIN |
| `05_dawn.dtl` | `07_final_goodend_dawn.dtl` | GOODEND |
| `06_epilogue.dtl` | `08_final_goodend_epilogue.dtl` | GOODEND |
